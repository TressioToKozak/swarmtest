(function(root,factory){const api=factory();if(typeof module==='object'&&module.exports)module.exports=api;else root.SwarmSaveState=api})(typeof globalThis!=='undefined'?globalThis:this,()=>{
  ...
  function startupFlow(multiplayerSession,save){if(multiplayerSession&&typeof (multiplayerSession.lobbyCode||multiplayerSession.code)==='string'&&typeof multiplayerSession.playerId==='string')return'multiplayer-reconnect';return validateSingleplayerSave(save)?'singleplayer-continue':'fresh-menu'}
