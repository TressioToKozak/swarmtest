...
const ui = Object.fromEntries(['timer','kills','level','healthText','healthBar','xpLevel','xpText','xpBar','slots','cards','startModal','instructionsModal','levelModal','endModal','newLevel','endStats'].map(id=>[id,document.getElementById(id)]));
