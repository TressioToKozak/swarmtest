(() => {
  ...
  function accept(message){
    ...
    if(message.type==='gameStarted'){
      ...
      screenShake=0;rings=[];playerEchoes=[];pendingInputs=[];isDead=false;isSpectator=false;
    }
