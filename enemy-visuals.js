...
(()=>{
  ...
  window.enemySpriteVisuals={configs,bossConfigs,sheets,ENEMY_ASSET_VERSION,drawProjectile,drawExplosion,drawCloud,drawTrap,drawRing,EXPLODER_EXPLOSION_DIAMETER:290};
